...
import { CustomerRequestComponent } from 'app/entities/siparis/customer-request/customer-request.component';
...
describe('Component Tests', () => {
    describe('CustomerRequest Management Component', () => {
        let comp: CustomerRequestComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CustomerRequestComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.customerRequests[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
